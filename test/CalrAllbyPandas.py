import sqlite3
import pandas as pd
from ecom.MakeExcel.writeExcel import writeExcel
...
def calrAll(month):
    ...
    conn.execute(
        ...
        (month, plt, pre_plt, imp_plt, all_plt_nogzd, pre_plt_nogzd, imp_plt_nogzd, ops_plt,
         ...
         sale_plt, james_plt, austin_plt, ivy_plt, louis_plt, elaine_plt, colin_plt, yaoqi_plt, elizabeth_plt, hellen_plt,
